...
import com.adaptionsoft.games.trivia.runner.ConsoleGameStatusHandlerImpl;
...
public class GameTest {
    ...
    @Before
    public void setUp() {
        underTest = new Game(new ConsoleGameStatusHandlerImpl());
    }

    @Test
    public void wasCorrectlyAnsweredAddsCoinToCurrentPlayer() {
        //GIVEN
        underTest.add(new Player("testPlayer"));
        underTest.setFirstPlayer();
        //WHEN
        underTest.wasCorrectlyAnswered();
        //THEN
        Assert.assertEquals(1, underTest.currentPlayer.getPurse());
    }
    ...
    public void nextPlayerWasCalledAfterCorrectAnswer() {
        ...
        underTest.wasCorrectlyAnswered();
        //THEN
        Assert.assertEquals(testPlayer2, underTest.currentPlayer);
    }
//
//  @Test
//  public void testAdd() {
